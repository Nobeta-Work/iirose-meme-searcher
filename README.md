...
**选项 1：GitHub Raw（推荐，实时生效）**

```text
https://raw.githubusercontent.com/Nobeta-Work/iirose-meme-searcher/v0.1.0/dist/bundle.js
```

**选项 2：jsdelivr CDN（国内访问更快）**

```text
https://cdn.jsdelivr.net/gh/Nobeta-Work/iirose-meme-searcher@v0.1.0/dist/bundle.js
```

如果选项 2 访问失败，请使用选项 1 或访问 `https://purge.jsdelivr.net/gh/Nobeta-Work/iirose-meme-searcher@v0.1.0/dist/bundle.js` 刷新 CDN 缓存。
